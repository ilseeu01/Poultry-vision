export default {
  ...
  gradients: {
    ...
    sidenav: {
      deg: "127.09",
      main: "rgba(10, 24, 18, 0.94) 19.41%",
      state: "rgba(8, 20, 16, 0.55) 76.65%",
    },
    ...
    box: {
      deg: "126.97",
      main: "rgba(10, 24, 18, 0.74) 28.26%",
      state: "rgba(8, 20, 16, 0.71) 91.2%",
    },
...
inputColors: {
  backgroundColor: "#0e1512", // 기존 네이비 → 다크그린 차콜
  borderColor: { main: "rgba(170, 200, 180, 0.25)", focus: "rgba(170, 200, 180, 0.55)" },
  boxShadow: "#2fa36f",
  error: "#fd5c70",
  success: "#66d432",
},
